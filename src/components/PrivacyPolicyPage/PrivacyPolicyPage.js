...
function PrivacyPolicyPage() {
  return (
    <main id="MainZone">
  <section
    className="privacy-policy v1 bg-box-like light-bg"
    id="PrivacyPolicyV1"
    data-onvisible="show"
  >
    <div className="main thin">
      <div className="bg-box side-padding vertical-padding-small box-flair">
        <div className="flair-border">
          <span className="flair-1" />
          <span className="flair-2" />
          <div className="content-style ui-repeater" id="PrivacyPolicyV1Policy">
            <div data-item="i">
              <h1>Privacy Policy</h1>
              <p>
                We recognize that you may be concerned about our use and
                disclosure of your personal information. Your privacy is very
                important to us, and the following will inform you of the
                information that we, Watermen Plumbing, may collect from you,
                and how it is used. By using our website,
                www.watermenplumbing.com, you are accepting the practices
