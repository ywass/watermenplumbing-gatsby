    ...
    <div className="main">
      <nav className="relative bg-box border-radius-item no-shadow">
        <ol className="flex-middle">
          ...
          <li className="flex-middle relative">2017</li>
        </ol>
      </nav>
    </div>
  </section>
    ...
    <div className="main vertical-padding-small flex-spaced-between-block-1024-margined flex-direction">
      <div className="content-zone two-thirds" id="ContentZone">
        <form
          ...
          action="https://www.watermenplumbing.com/blog/2017/"
          data-search={1}
        >
          <input
            type="hidden"
                  ...
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Sep 12, 2017">Sep 12</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        5 Post Hurricane Plumbing Problems to Watch For
                      </strong>
                      <p className="hide-800">
                        Now that everyone is returning back to their homes after
                        the major evacuation from Florida we wanted to keep you
                        informed about ...
                      </p>
                    </div>
              ...
              >
                ...
                >
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Apr 30, 2017">Apr 30</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Clogged Drain: Call a Plumber or Do it Myself?
                      </strong>
                      <p className="hide-800">
                        My Drain Is Clogged What to Do? Calling a plumber Vs
                        Drain Chemicals So, your drain is clogged, you now have
                        a choice to make, do ...
                      </p>
                    </div>
                    <span className="fit btn v2">View Article</span>
...
export default TwentySeventeenPages