      ...
      <div className="main">
        <nav className="relative bg-box border-radius-item no-shadow">
          <ol className="flex-middle">
            ...
            <li className="flex-middle relative">January</li>
          </ol>
        </nav>
      </div>
    </section>
      ...
      <div className="main vertical-padding-small flex-spaced-between-block-1024-margined flex-direction">
        <div className="content-zone two-thirds" id="ContentZone">
          <form
            ...
            action="https://www.watermenplumbing.com/blog/2021/january/"
            data-search={1}
          >
            <input
              type="hidden"
                  ...
                  >
                    ...
                    >
                      <img
                        ...
                        alt="Sink with old faucet currently installed and new long neck faucet placed on sink ready to be installed."
                        data-src="../../../cms/thumbnails/34/480x240/assets/blogs/Hire-A-Plumber-Blog-Cover.jpg"
                      />
                    </div>
                    <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                      <div className="auto full">
                        <span className="blog-time-style full">
                          <time content="Jan 28, 2021">Jan 28</time>
                        </span>
                        <strong className="title-style-4 title-color-4">
                          Benefits of Hiring a Professional Plumber
                        </strong>
                        <p className="hide-800">
                          Water goes everywhere in a modern home and wherever
                          water goes, the possibility for water damage follows.
                          This would not be a big ...
                        </p>
                      </div>
...
export default January2021Pages