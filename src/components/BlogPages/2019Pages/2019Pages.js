    ...
    <div className="main">
      <nav className="relative bg-box border-radius-item no-shadow">
        <ol className="flex-middle">
          ...
          <li className="flex-middle relative">2019</li>
        </ol>
      </nav>
    </div>
  </section>
    ...
    <div className="main vertical-padding-small flex-spaced-between-block-1024-margined flex-direction">
      <div className="content-zone two-thirds" id="ContentZone">
        <form
          ...
          action="https://www.watermenplumbing.com/blog/2019/"
          data-search={1}
        >
          <input
            type="hidden"
                  ...
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Jun 4, 2019">Jun 04</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Would This Anti-Scale System Defeat Godzilla?
                      </strong>
                      <p className="hide-800">
                        DO YOU NEED A GODZILLA ANTI-SCALE SYSTEM: Imagine if the
                        military had a weapon that could remove the scales from
                        Godzilla or any ...
                      </p>
                    </div>
              ...
              >
                ...
                >
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="May 15, 2019">May 15</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Where Does Your Water Come From?
                      </strong>
                      <p className="hide-800">
                        Flint, Michigan might be miles and miles away, but
                        Florida is starting to find some common ground.
              ...
              >
                ...
                >
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Apr 12, 2019">Apr 12</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Florida School Plumbing Problems Warning!﻿
                      </strong>
                      <p className="hide-800">
                        Do you have a child in school here in South Florida? Did
                        you know that Florida doesn’t require schools to test or
                        even filter the ...
                      </p>
                    </div>
                    <span className="fit btn v2">View Article</span>
              ...
              >
                ...
                >
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Feb 26, 2019">Feb 26</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Never Flush These Things Down the Toilet &amp; Why
                      </strong>
                      <p className="hide-800">
                        Some things just don’t flush! Did you know that your
                        home or place of work uses a network of pipes to dispose
                        of sewage? This ...
                      </p>
                    </div>
                    <span className="fit btn v2">View Article</span>
              ...
              >
                ...
                >
                  <div className="flex-column-top side-padding-large vertical-padding-tiny full auto">
                    <div className="auto full">
                      <span className="blog-time-style full">
                        <time content="Jan 10, 2019">Jan 10</time>
                      </span>
                      <strong className="title-style-4 title-color-4">
                        Old House Pipes Add WHAT to Your Drinking Water?
                      </strong>
                      <p className="hide-800">
                        Where is your drinking water coming from? What kind of
                        pipes are in your walls? There are many different types
                        of piping we use to ...
                      </p>
                    </div>
                    <span className="fit btn v2">View Article</span>
...
export default TwentyNineteenPages