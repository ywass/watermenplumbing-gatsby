...
import leakCeilingImg from '../../images/leaks-ceiling-repair-hollywood-fl-300x225-1.jpg'
import { Link } from 'gatsby'
function LeakDetectionRepairPage() {
  return (
    <main id="MainZone">
  <section
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Leak Detection in Boca Raton</h1>
                <h2>Call Watermen Plumbing Inc. in Palm Beach County Today</h2>
                <p>
                  Leaks can be misleading. Water may be present in one area but
                  often will be coming from an entirely different location. With
                  our experience and extensive knowledge of how the plumbing
                  system works we are able to faster locate and repair leaks,
                  with minimal damage to your home, which means less cost and
                  headache for you.
                </p>
                <p>
                  Water leaks can be some of the most expensive repairs that
                  happen in your home. Most leaks you’ll be able to see, like
                  faucet leaks, others may be hidden behind walls, under floors,
                  or even in your backyard. These you might not notice until
                  there are water stains or holes in your drywall, soft wet
                  spots on your floor, or a few hundred dollars owed on your
                  water bill!
                </p>
                <p>
                  <img
                    alt="Hallandale Beach leak detection expert assessing a ceiling leak"
                    width={381}
                    height={286}
                    src={leakCeilingImg}
                  />
                ...
                <p>
                  The most common long term dangers of water leaks are mold and
                  mildew! Both of these can lead to health problems, including
                  respiratory issues, as well as increased allergies. It can
                  also devalue your home. Keep your home or
                  <Link to="/plumbing-services/commercial-plumbing"> business </Link>{" "}
                  healthy and happy by addressing hidden water leaks as soon as
                  possible.
                </p>
                <p className="content-quote v1 bg-box unlike-bg side-padding-medium vertical-padding-tiny title-style-3 title-color-3">
                  <b>
                    Schedule an appointment with our Boca Raton leak detection
                    experts by calling
                    <Link
                      to="tel:(954) 800-6364"
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/leak-detection-repair/"
        >
...
export default LeakDetectionRepairPage