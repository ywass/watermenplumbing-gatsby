          ...
          <ul className="flex-grid-large-wrap-block-800 close-gap-800 results-19">
              ...
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    ...
                    friendly and professional and we are satisfied with the
                    experience.
                  </div>
              ...
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    ...
                    thing as clean as (or cleaner than) they found them. I also
                    like that they have an apprenticeship program. On the last
                    job they did for me, an apprentice came along to assist. He
                    was so positive about the program and the opportunity to
                    learn the trade. As a former teacher, I appreciate that.
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Karen S.
                  </p>
              ...
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    ...
                    promise and were very patient with my complicated building
                    admin office, going above and beyond to schedule the toilet
                    replacement a d make it work for all parties involved. Do
                    not try to “save some money” hiring elsewhere when you may
                    regret it later. Worth the investment.
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Sara S.R.
                  </p>
              ...
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    ...
                    person. I was advised via text what technician was
                    responding and when they would arrive. Everything was
                    explained to me prior to completing the work. Safety
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    On-time and professional. Complex faucet replacement was
                    done efficiently and quickly, with zero mess afterwards!
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - John L.
                  </p>
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  <strong className="title-style-2 title-color-2">
                    Professional from the very first contact to the very last
                    email!
                  </strong>
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    Quality service installing quality product and you should
                    put them at the very top of your call list the next time you
                    need a plumber.
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Charles K.
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    Excellent service! I ran into a couple of situations where
                    parts needed to be ordered, etc., they took care of
                    everything. Sharp on the time they set the appointments for.
                    The price is reasonable.&nbsp; From now on, I know who to
                    call. Not the ghostbusters, but the Watermen!
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Past Customer
                  </p>
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    <p>
                      I've used them twice - great professionals. I would
                      recommend them for the person who insists on top quality
                      workmanship.
                    </p>
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    <p>
                      Excellent service. Careful and methodical. Very fast
                      response. Thanks!
                    </p>
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    Not only is he our Plumber but one of our Tenants, Yosef is
                    very accurate with his recommendations and estimates. I
                    highly recommend Watermen Plumbing! Great work and very
                    professional.
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Nancy R.
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    Reliable company as there are very few around. Always on
                    time, and needless to say their work quality is second to
                    none. I have used them several times and just called them to
                    be part of my bathroom remodeling project. Tonight I will
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    <p>
                      What a wonderful and professional operation. In the
                      future, we will always call Watermen!
                    </p>
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Laban Y.
              ...
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <div className="content-style">
                    ...
                    time everything was processed and explain clearly. Most of
                    all they were very affordable.
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Dovi W.
                  </p>
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    Honest &amp; Good! Very professional! I’ve used many
                    plumbers over the years, but he is the best!
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Mendy T.
                  </p>
            ...
            >
              <blockquote className="flex-column-between full relative">
                <div className="info auto side-padding-large vertical-padding-small">
                  ...
                  <QuoteIcon className="quote-icon top-margin-tiny" />
                  <div className="content-style">
                    The absolute best! Uses high-grade equipment that lasts
                    forever! Very professional, nice, and every job he did for
                    me turned out perfect!! Highly recommend!
                  </div>
                  <p className="title-style-5 title-color-5 no-bottom-margin">
                    - Leelee E.
                  </p>
