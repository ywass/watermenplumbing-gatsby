...
import filterTankImg from '../../../../images/filter-tank-500.jpg'
import pdfOne from '../../../../../static/productBrochures/One-One-Sheet-2.pdf'
import { Link } from 'gatsby'
function FirstFilterTanksProductPage() {
  return (
    <main id="MainZone">
    <section
        ...
        >
          <div className="flair-border">
            ...
            <span className="title-font title-color-1">
              <strong>One™ Cartridge Filter Tank</strong>
            </span>
      ...
      <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
            ...
            <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
              <div className="flair-border" data-content="true">
                ...
                <div
                  ...
                  data-content="true"
                >
                  <h1 itemProp="name">One™ Cartridge Filter Tank</h1>
                  <p>
                    <img
                      ...
                      src={filterTankImg}
                    />
                    The unique ONE™ Cartridge Tank filter system is the solution
                    to consistently needing to replace smaller, more commonly used
                    cartridge filters. The Cartridge Filter Tank comes in two
                    different options to tackle any size application needed from
                    residential to larger commercial needs . It is the ideal
                    solution for the removal of a multitude of particulates. Ideal
                    for most water conditions.
                  </p>
                  <ul>
                    <li>
                      Specifically designed for higher flow rates &amp; higher
                      contaminant retention capacities
                    </li>
                    <li>
                      Wide variety of application-specific cartridges available
                    </li>
                    <li>
                      Easy to service &amp; replaces — no special tools required
                    </li>
                    <li>
                      Optional bottom drain — allows particles to flush from the
                      system and extends cartridge life
                    </li>
                  </ul>
                  <h4>Cartridge Options:</h4>
                  <ul>
                    <li>3 micron CS Carbon – 150,000 Gallons at 7 GPM</li>
                    <li>20 micron CS Carbon – 250,000 Gallons at 15 GPM</li>
                    <li>3 micron CX Carbon – 150,000 Gallons at 7 GPM</li>
                  </ul>
        ...
        <div className="side-zone" id="SideZone">
          ...
          netlify
            ...
            action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/filter-tanks/one-cartridge-filter-tank/"
          >
...
export default FirstFilterTanksProductPage