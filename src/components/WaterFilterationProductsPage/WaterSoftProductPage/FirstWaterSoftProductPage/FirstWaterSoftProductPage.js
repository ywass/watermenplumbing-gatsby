      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Flow-Tech Dual Function Softener/Filter</strong>
          </span>
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1 itemProp="name">Flow-Tech Dual Function Softener/Filter</h1>
                <h3>
                  Model(s):
                  <strong>109457 (standard) &amp; 109458 (large)</strong>
                </h3>
                <p>
                  <img
                  ...
                  the clear, soft, odor-free water you to see poured into your
                  glass.
                </p>
                <p>
                  The system combines two separate filters into one sleek
                  environmentally-friendly designed tank. The activated carbon
                  removes chlorine and other unwanted tastes while the high
                  capacity resin is used to soften the water.
                </p>
                <h4>Size Options:</h4>
                <ul>
                  <li>
                ...
                <ul>
                  <li>
                    Special “mid-plate” design combines two filters into one
                    tank
                  </li>
                  <li>
                    Uses household trend of water consumption to monitor &amp;
                    self-adjust
                  </li>
                  <li>Extended lithium battery backup</li>
                  <li>
                    Increased efficiency - allowing for less energy &amp; water
                    to be used and less wear &amp; tear on your clothes &amp;
                    appliances
                  </li>
                  <li>Extends the life of resin media on chlorinated water</li>
                  <li>Diagnostic screen allows historic data comparison</li>
                </ul>
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/water-softeners/flow-tech-dual-function-softener-filter/"
        >
...
export default FirstWaterSoftProductPage