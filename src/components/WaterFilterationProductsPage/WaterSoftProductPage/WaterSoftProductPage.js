    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Flow-Tech Water Softeners</h1>
                <ul>
                  <li>
                    <h4>
                      <Link
                        title="Flow-Tech Dual Function Softener/Filter"
                  ...
                  <li>
                    <h4>
                      <Link
                        title="Flow-Tech Ion Exchange Water Softener"
      ...
      <div className="side-zone" id="SideZone">
        ...
        netlify
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/water-softeners/"
        >
...
export default WaterSoftProductPage