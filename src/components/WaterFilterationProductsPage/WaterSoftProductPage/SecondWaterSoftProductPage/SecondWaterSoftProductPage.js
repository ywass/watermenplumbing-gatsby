      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Flow-Tech Ion Exchange Water Softener</strong>
          </span>
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1 itemProp="name">Flow-Tech Ion Exchange Water Softener</h1>
                <h3>
                  Model(s):
                  <strong>
                    109467 (standard), 109469 (large), &amp; 109465 (small)
                  </strong>
                </h3>
                <p>
                  <img
                  ...
                  your general area is regularly detailed in your neighborhood
                  annual water quality report. On the off chance that you don't
                  have a clue about the hardness in your general area, your
                  Watermen Plumber will be happy to conduct a simple test for
                  you.
                </p>
                <p>
                  If you determine that you have hard water, you ought to think
                  about a Flow-Tech ion exchange water softener or descaler.
                  Spots on your dishes and limescale build up on fixtures are
                  more than an annoyance. Scale can cause water-using machines
                  to work harder, which requires more energy and cuts the
                  lifetime of those appliances. You may have also noticed that
                  it takes more detergent to get your laundry clean.
                </p>
                <p
                ...
                >
                  <strong>
                    ...
                    to learn more about hard water and the potential need for a
                    Flow-Tech water softener.
                  </strong>
                </p>
                <p>
                  A properly selected and sized system can ultimately save you
                  money through reduced soap and detergent usage, energy
                  efficiency, longer life for clothing and linens, and long
                  productive life for your water-using appliances.
                </p>
                <p>
                  You should expect a minimum of three years and likely longer,
                  before the resin media needs to be replaced. Salt or potassium
                  will need to be added periodically as prescribed by your
                  service professional. The variance in longevity is based on
                  water consumption levels and the levels of impurities in your
                  water supply.
                </p>
                <p>
                  We recommend having your service provider check your system
                  annually to ensure it is working properly.
                </p>
                <h4>Size Options:</h4>
                <ul>
                  <li>
      ...
      <div className="side-zone" id="SideZone">
        ...
        >
          <nav>
            <header className="text-left">
              <Link to="/plumbing-services/water-filtration/water-filtration-products/water-softeners">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/water-softeners/flow-tech-ion-exchange-water-softener/"
        >
...
export default SecondWaterSoftProductPage