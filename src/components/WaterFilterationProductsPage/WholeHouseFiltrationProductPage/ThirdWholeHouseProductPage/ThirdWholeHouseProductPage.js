...
import cxCarbonImg from '../../../../images/cx-carbon-whole-house-filter-500.png'
import pdfOne from '../../../../../static/productBrochures/PC-Carbon-CX-OneSheet.pdf'
import pdfTwo from '../../../../../static/productBrochures/CX-FIlter-Owner-Basics.pdf'
import { Link } from 'gatsby'
function ThirdWholeHouseProductPage() {
  return (
    <main id="MainZone">
  <section
      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Flow-Tech Pure CX Carbon Whole-House Water Filter</strong>
          </span>
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Flow-Tech Pure CX Carbon Whole-House Water Filter</h1>
                <h3>
                  Model(s):
                  <strong>109455 (standard) &amp; 109456 (large)</strong>
                </h3>
                <p>
                  <img
                    className="media-small media-right"
                    alt="Cx Carbon Whole House Filter 500"
                    src={cxCarbonImg}
                  />
                  A whole house carbon filter is a convenient and effective way
                  to eliminate or reduce chemicals, bacteria, and other nasty
                  by-products, found in your normal water supplies. Designed to
                  tackle chloramines and chlorine odors and taste in your homes
                  water. The system uses Centaur catalytic carbon as this
                  particular carbon filters out chloramines more efficiently
                  than standard granular activated carbon.
                </p>
                <p>
                  When properly sized for your home, the system is expected to
                  provide a minimum of 5-years, and effectively longer before
                  the media needs to be replaced, and it needs to contain the
                  proper type of carbon based on your water’s content. The
                  variance in longevity is based on water consumption levels and
                  the levels of impurities in your water supply. The carbon beds
                  can be redone when the effectiveness of the carbon has been
                  used past its point of efficiency.
                </p>
                <h4>Size Options:</h4>
                <ul>
                  <li>
                ...
                <h4>Benefits:</h4>
                <ul>
                  <li>Clean, filtered water from every tap</li>
                  <li>
                    Reduction or removal of chlorine, chloramines and associated
                    disinfectant by-products
                  </li>
                  <li>
                    Improved taste on any beverages that require water (Coffee,
                    Tea, Powdered Drinks)
                  </li>
                  <li>
                  ...
                  <li>
                    Reduce environmental waster and save money cutting out
                    buying prepackaged water bottles
                  </li>
                </ul>
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/whole-house-filtration-systems/flow-tech-pure-cx-carbon-whole-house-water-filte/"
        >
...
export default ThirdWholeHouseProductPage