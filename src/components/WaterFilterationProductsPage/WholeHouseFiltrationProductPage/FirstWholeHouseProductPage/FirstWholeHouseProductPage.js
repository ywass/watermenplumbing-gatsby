...
import flowSulfurImg from '../../../../images/flowtech-home-sulfur-filter-500.jpg'
import { Link } from 'gatsby'
function FirstWholeHouseProductPage() {
  return (
    <main id="MainZone">
  <section
      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Flow-Tech Home Sulfur Filter</strong>
          </span>
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Flow-Tech Home Sulfur Filter</h1>
                <p>
                  <img
                    className="media-small media-right"
                    alt="Flowtech Home Sulfur Filter 500"
                    src={flowSulfurImg}
                  />
                  The Flow-Tech Home Sulfur Filter is effective in removing
                  hydrogen sulfide, commonly associated with problem well water.
                  This system is environmentally safe and uses a unique
                  air-injection filtering technology to oxidize sulfur into
                  precipitates that can be readily filtered and removed. The
                  result is simply refreshingly good water from the tap of your
                  home year-round.
                </p>
                <h4>Features:</h4>
                <ul>
                  ...
                  <li>
                    Easily programmed for optimum performance by your service
                    contractor
                  </li>
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/whole-house-filtration-systems/flow-tech-home-sulfur-filter/"
        >
...
export default FirstWholeHouseProductPage