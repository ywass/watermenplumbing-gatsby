...
import cxWholeImg from '../../../../images/cx-carbon-whole-house-filter-500.png'
import pdfOne from '../../../../../static/productBrochures/PC-Carbon-CS-OneSheet.pdf'
import { Link } from 'gatsby'
function SecondWholeHouseProductPage() {
  return (
    <main id="MainZone">
    <section
        ...
        >
          <div className="flair-border">
            ...
            <span className="title-font title-color-1">
              <strong>Flow-Tech PURE CS Carbon Whole-House Water Filter</strong>
            </span>
      ...
      <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
            ...
            <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
              <div className="flair-border" data-content="true">
                ...
                >
                  ...
                  <h4>
                    Model(s):
                    <strong>109477(standard) &amp; 109463(large)</strong>
                  </h4>
                  <p>
                    <img
                      ...
                      src={cxWholeImg}
                    />
                    You may ask yourself, what is a convenient, cost efficient way
                    to effectively filter out many of the undesirable chemicals,
                    nasty by-products, and organics commonly found in your water
                    supplies. Well the answer would be Whole-House Carbon Water
                    Filters.
                  </p>
                  <p>
                    Whole House Carbon CS Filters are designed for household use
                    and ideal for improving your water's taste and smell.
                  </p>
                  <p>
        ...
        <div className="side-zone" id="SideZone">
          ...
          <form
            ...
            action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/whole-house-filtration-systems/flow-tech-pure-cs-carbon-whole-house-water-filte/"
          >
...
export default SecondWholeHouseProductPage