...
import alwaysFreshWaterImg from '../../../../images/always-fresh-drinking-water-system-500.png'
import pdfOne from '../../../../../static/productBrochures/FTH-alwaysfresh-OneSheet-2.pdf'
import { Link } from 'gatsby'
function FirstDrinkingWaterProductPage() {
  return (
    <main id="MainZone">
    <section
        ...
        >
          <div className="flair-border">
            ...
            <span className="title-font title-color-1">
              <strong>AlwaysFresh® Drinking Water System</strong>
            </span>
      ...
      <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
            ...
            <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
              <div className="flair-border" data-content="true">
                ...
                <div
                  ...
                  data-content="true"
                >
                  <h1 itemProp="name">AlwaysFresh® Drinking Water System</h1>
                  <h3>
                    Model(s):
                    <strong>108385 (system) &amp; 108394 (cartridge)</strong>
                  </h3>
                  <p>
                    <img
                      className="media-right media-small"
                      alt="Always Fresh Drinking Water System 500"
                      src={alwaysFreshWaterImg}
                    />
                    The AlwaysFresh® Drinking Water System is one of the top of
                    the line point of use drinking water system. It allows your
                    water to be filtered down to the tiniest 0.5 micron particles
                    without the typical water waste seen in most Reverse Osmosis
                    systems.
                  </p>
                  <p>
                    AlwaysFresh® provides a high flow 1.5 gpm high
                    capacity/performance drinking water system. The best part of
                    the AlwaysFresh® system is that it does not require any extra
                    faucets or attachments to add to the clutter around your sink.
                    You will enjoy the taste of fresh filtered water from your
                    existing kitchen cold faucet.
                  </p>
                  <p>
                    AlwaysFresh® removes unpleasant chlorine taste and odor from
                    your ice cubes, drinking water, coffee, teas &amp; food.
                  </p>
                  <ul>
                    <li>
                    ...
                    <li>
                      Extendable lifetime guarantee and easy to swap cartridges.
                    </li>
                    <li>
                      Ability to connect to your ice maker and other faucets with
                      ease.
                    </li>
                    <li>Available for kitchen and/or bathroom use.</li>
                    <li>
                      Cartridges only need to be replaced once a year* (*based on
                      average usage and incoming water supply)
                    </li>
                  </ul>
                  <h4>Specs:</h4>
                  <ul>
                    <li>Annual Cartridge Replacement Recommended</li>
                    <li>Rated for 500 Gallons</li>
                    <li>Filters down to .5 microns</li>
        ...
        <div className="side-zone" id="SideZone">
          ...
          netlify
            ...
            action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/drinking-water-systems/alwaysfresh-drinking-water-system/"
          >
...
export default FirstDrinkingWaterProductPage