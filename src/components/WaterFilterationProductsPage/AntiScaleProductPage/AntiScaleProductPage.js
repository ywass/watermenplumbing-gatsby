      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Anti-Scale Systems</strong>
          </span>
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Flow-Tech Anti-Scale Systems</h1>
                <ul>
                  <li>
                    <h4 itemProp="name">
                      <Link to="/plumbing-services/water-filtration/water-filtration-products/anti-scale-systems/flow-tech-home-max-anti-scale-system">
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
         netlify
          ...
          action="https://www.watermenplumbing.com/plumbing-services/water-filtration/water-filtration-products/anti-scale-systems/"
        >
...
export default AntiScaleProductPage