      ...
      >
        <div className="flair-border">
          ...
          <span className="title-font title-color-1">
            <strong>Camera Drain Inspection</strong>
          </span>
    ...
    <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
          ...
          <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
            <div className="flair-border" data-content="true">
              ...
              <div
                ...
                data-content="true"
              >
                <h1>Camera Drain Inspections in Boca Raton</h1>
                <h2>
                  Get Skilled Assistance from Our Quality Palm Beach County
                  Plumbers
                </h2>
                <p>
                  Camera drain inspections are mainly done to locate causes of
                ...
                <p>
                  At Watermen Plumbing Inc. we invest in the latest and greatest
                ...
                <p>
                  <b>Check out why you may need plumbing video inspection:</b>
                </p>
                <ul>
                  <li>
                    <b>Retrieving Lost Items</b>: Losing a sentimental or
                    valuable item down the drain can seem hopeless. With our
                    video inspection, we can help you save time and money in
                    locating your missing item.
                  </li>
                  <li>
                    <b>Inspecting Potential Homes</b>: Want to make sure you
                    won’t inherit plumbing problems from a previous property
                    owner? Schedule a video inspection of your potential home
                    with our plumbing experts.
                  </li>
                  <li>
                    <b>Inspecting Septic Systems</b>: Our inspections allow you
                    to monitor the health of your septic system and let you know
                    when repairs or maintenance are necessary.
                  </li>
                  <li>
                    <b>Remodeling Inspections</b>: Before you add a bathroom or
                    remodel your kitchen, make sure your plumbing system can
                    withstand new additions and increased waste and flow.
                  </li>
                </ul>
      ...
      <div className="side-zone" id="SideZone">
        ...
        <form
          ...
          action="https://www.watermenplumbing.com/plumbing-services/drain-issues/camera-drain-inspection/"
        >
...
export default CameraDrainInspectionPage