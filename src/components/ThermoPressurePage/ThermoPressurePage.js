        ...
        >
          <div className="flair-border">
            ...
            <span className="title-font title-color-1">
              <strong>Thermostatic Pressure Balancing</strong>
            </span>
      ...
      <div className="main flex-spaced-between-block-1024-margined item-spacing item-widths flex-direction">
            ...
            <div className="bg-box side-padding-medium vertical-padding-small box-flair border-radius">
              <div className="flair-border" data-content="true">
                ...
                <div
                  ...
                  data-content="true"
                >
                  <h1>Boca Raton Thermostatic Pressure Balancing</h1>
                  <h2>
                    Helping You Make the Most of Your Plumbing System in Palm
                    Beach County
                  </h2>
                  <p>
                    Have you ever been blasted by scalding hot water in the
                    shower, after someone in your house either flushes a toilet or
                    runs the water in another room? You completely understand the
                    need for why thermostatic pressure balancing is even a thing.
                    With this installed and calibrated, it prevents scalding water
                    from passing through the showerhead or tub faucet via a
                    thermostat!
                  </p>
                  <p>
                    Watermen Plumbing Inc. can calibrate the thermostat during
                    installation using a thermometer, in order to keep the
                    temperature reading on the control accurate. An additional
                    safety feature is a heat limit, which can be set (or not) by
                    your plumber to prevent the hottest temperature on the valve
                    from exceeding 120° F. This also prevents children from
                    getting scalded by water in the home during bath time.
                  </p>
        ...
        <div className="side-zone" id="SideZone">
          ...
          <form
            ...
            action="https://www.watermenplumbing.com/plumbing-services/thermostatic-pressure-balancing/"
          >
...
export default ThermoPressurePage