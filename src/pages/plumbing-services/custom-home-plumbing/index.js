...
import CustomHomePlumbingPage from '../../../components/CustomHomePlumbingPage/CustomHomePlumbingPage'
...
query PageQueryPS17 {
  PageData : prismicPlumbingservices(uid: {eq: "custom-home-plumbing"}) {
    data {
      seo_title
      seo_description
      seo_social_image {
