...
import LeakDetectionRepairPage from '../../../components/LeakDetectionRepairPage/LeakDetectionRepairPage'
import Seo from '../../../components/seo'

function index() {
  return (
    <Layout>
     <LeakDetectionRepairPage/>
    </Layout>
  )
}
...
query PageQueryPS15 {
  PageData : prismicPlumbingservices(uid: {eq: "leak-detection-repair"}) {
    data {
      seo_title
      seo_description
      seo_social_image {
