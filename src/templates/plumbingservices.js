...
const PlumbingservicesPage = props => {
      ...
      <Layout>
        ...
        <div className="max-w-7xl mx-auto px-4 md:py-20 py-12">
          <div className="flex gap-8 md:flex-row flex-col services">
                  ...
                  <ul>
                    {services &&
                      services.map((item, index) => {                  
                        return (
                          <li key={index}>
                            <Link to={`/plumbing-services/${item?.node?.uid}`}>{item.node.data.title.text}</Link>
                          </li>
                        )
                      })}
                  </ul>
            ...
            <div className="md:w-3/4 w-full page_content">
              <SliceZone
                slices={PageBody}
...
export const query = graphql`
  query prismicPlumbingservicesPageQuery($id: String!) {
    PageData: prismicPlumbingservices(id: { eq: $id }) {
      data {
        seo_title
        seo_description
        seo_social_image {
        ...
        body {
          ...plumbingservicesDataBodyContentonlysection
          ...plumbingservicesDataBodyCtaSection2
          ...plumbingservicesDataBodyPageBanner
          ...plumbingservicesDataBodyContentimagesection
          ...plumbingservicesDataBodyButtonsSection
          ...plumbingservicesDataBodyContentonlysection
          ...plumbingservicesDataBodyCtaSection1
        }
